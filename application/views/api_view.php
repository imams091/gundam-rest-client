<html>
<head>
    <title>1818011 rest client</title>
...
<body>
    <div class="container">
        <br />
        <h3 align="center">Katalog harga dan grade model kit gundam</h3>
        <br />
        ...
        <form method="post" id="user_form">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">tambah katalog</h4>
                </div>
                <div class="modal-body">
                    <label>Nama model kit</label>
...
$(document).ready(function(){
    ...
    {
        $.ajax({
            url:"<?php echo base_url(); ?>gundam_client/action",
            method:"POST",
    ...
    $('#add_button').click(function(){
        $('#user_form')[0].reset();
        $('.modal-title').text("tambah katalog");
        $('#action').val('Add');
